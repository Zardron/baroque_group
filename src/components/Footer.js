...
const Footer = () => {
  return (
    <Container>
      ...
      <Center>
        <List>
          <ListItem style={{cursor: "pointer"}}>Day Charter Yachts</ListItem>
          <ListItem style={{cursor: "pointer"}}>Weekly Charter Yachts</ListItem>
          <ListItem style={{cursor: "pointer"}}>Type of charter</ListItem>
          <ListItem style={{cursor: "pointer"}}>Corporate Charter</ListItem>
          <ListItem style={{cursor: "pointer"}}>Regions & Destinations</ListItem>
          <ListItem style={{cursor: "pointer"}}>Featured Itineraries</ListItem>
          <ListItem style={{cursor: "pointer"}}>Private Events and Experience</ListItem>
          <ListItem style={{cursor: "pointer"}}>Global Events Calendar</ListItem>
        </List>
      </Center>
      <Right>
